...
//        }
    ...
    private fun showDeleteConfirmationDialog(postingId: Int) {
        ...
        builder.setTitle(getString(R.string.delete_alert_posting))
            .setMessage(getString(R.string.are_you_sure_delete_posting))
    ...
    private fun showNoLogin() {
        ...
        binding.komentarAdd.visibility = View.GONE
